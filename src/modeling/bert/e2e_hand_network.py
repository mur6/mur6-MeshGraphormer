...
def generate_t_pose_template_mesh(mesh_model):
    ...
    return template_vertices, template_3d_joints


def get_template_vertices_sub(mesh_sampler, template_vertices):
    template_vertices_sub = mesh_sampler.downsample(template_vertices)
    return template_vertices_sub


def template_normalize(template_vertices, template_3d_joints, template_vertices_sub):
    ...
    return template_vertices, template_3d_joints, template_vertices_sub
...
class Graphormer_Hand_Network(torch.nn.Module):
    ...
    def forward(
        self, images, template_vertices, template_3d_joints, template_vertices_sub, meta_masks=None, is_train=False
    ):
